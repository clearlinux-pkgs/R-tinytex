...
Version  : 0.33
Release  : 54
URL      : https://cran.r-project.org/src/contrib/tinytex_0.33.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tinytex_0.33.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628214650
