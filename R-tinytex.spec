...
Version  : 0.55
Release  : 93
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/tinytex_0.55.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/tinytex_0.55.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740000149
...
/usr/lib64/R/library/tinytex/tests/test-ci/test-dvi.tex
/usr/lib64/R/library/tinytex/tests/test-ci/test-install.R
/usr/lib64/R/library/tinytex/tests/test-ci/test-latex.R
