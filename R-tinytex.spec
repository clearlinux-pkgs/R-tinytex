...
Version  : 0.41
Release  : 70
URL      : https://cran.r-project.org/src/contrib/tinytex_0.41.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tinytex_0.41.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660670930
