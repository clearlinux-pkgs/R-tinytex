...
Version  : 0.35
Release  : 58
URL      : https://cran.r-project.org/src/contrib/tinytex_0.35.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tinytex_0.35.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636148027
