...
Version  : 0.14
Release  : 23
URL      : https://cran.r-project.org/src/contrib/tinytex_0.14.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tinytex_0.14.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1561484365
