...
Version  : 0.50
Release  : 87
URL      : https://cran.r-project.org/src/contrib/tinytex_0.50.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tinytex_0.50.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710614249
