...
Version  : 0.39
Release  : 67
URL      : https://cran.r-project.org/src/contrib/tinytex_0.39.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tinytex_0.39.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652804371
