...
Version  : 0.17
Release  : 26
URL      : https://cran.r-project.org/src/contrib/tinytex_0.17.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tinytex_0.17.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572543757
