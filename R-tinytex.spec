...
Version  : 0.13
Release  : 20
URL      : https://cran.r-project.org/src/contrib/tinytex_0.13.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tinytex_0.13.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1557847630
