...
Version  : 0.22
Release  : 34
URL      : https://cran.r-project.org/src/contrib/tinytex_0.22.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tinytex_0.22.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587171436
