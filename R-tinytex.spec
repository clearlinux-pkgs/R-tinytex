...
Version  : 0.42
Release  : 73
URL      : https://cran.r-project.org/src/contrib/tinytex_0.42.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tinytex_0.42.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664290423
