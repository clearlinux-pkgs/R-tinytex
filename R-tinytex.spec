...
Version  : 0.10
Release  : 10
URL      : https://cran.r-project.org/src/contrib/tinytex_0.10.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tinytex_0.10.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1547224352
