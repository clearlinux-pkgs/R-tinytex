...
Version  : 0.34
Release  : 56
URL      : https://cran.r-project.org/src/contrib/tinytex_0.34.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tinytex_0.34.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632843844
